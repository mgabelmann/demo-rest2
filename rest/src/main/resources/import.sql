...
INSERT INTO ADDRESS(address_id, attention, delivery_info, civic_address, postal_info, city, prov, postal, country, primary_address, person_id) VALUES (NEXTVAL('ADDRESS_ID_SEQ'), 'Bam Bam', null, '123 Bedrock St', null, 'Bedrock City', 'BC', '123456', 'Pangea', 'Y', 2);
