...
INSERT INTO GROUP_CODE(group_id, description) VALUES ('ZIP', 'Postal or Zip Code');
...
INSERT INTO GROUP_TYPE_CODE(group_id, type_id, description, position, effective, p_group_id, p_type_id) VALUES ('PRO', 'BC', 'British Columbia', 1, 'Y', 'CNT', 'CA');
INSERT INTO GROUP_TYPE_CODE(group_id, type_id, description, position, effective, p_group_id, p_type_id) VALUES ('PRO', 'ON', 'Ontario', 1, 'Y', 'CNT', 'CA');
...
INSERT INTO GROUP_TYPE_CODE(group_id, type_id, description, position, effective, p_group_id, p_type_id) VALUES ('PRO', 'CA', 'California', 1, 'Y', 'CNT', 'US');

INSERT INTO GROUP_TYPE_CODE(group_id, type_id, description, position, effective, p_group_id, p_type_id) VALUES ('ZIP', 'A', 'BBB', 1, 'Y', 'PRO', 'CA');
INSERT INTO GROUP_TYPE_CODE(group_id, type_id, description, position, effective, p_group_id, p_type_id) VALUES ('ZIP', 'B', 'DDD', 1, 'Y', 'PRO', 'CA');
INSERT INTO GROUP_TYPE_CODE(group_id, type_id, description, position, effective, p_group_id, p_type_id) VALUES ('ZIP', 'C', 'CCC', 1, 'Y', 'PRO', 'CA');
